...
menu $mbar.f4.sh
$mbar.f4.sh add command -label "From Reso <CTL-r>"   -command {load_base; set sys::modeVar "R"; set cmode::srch_mode "Reso"} -background #ffffff
$mbar.f4.sh add command -label "From Comp <CTL-c>"   -command {load_base; set sys::modeVar "C"; set cmode::srch_mode "Comp"} -background #ffffff
$mbar.f4.sh add command -label "From Blue <CTL-b>"   -command {load_base; set sys::modeVar "B"; set cmode::srch_mode "Blue"} -background #ffffff
